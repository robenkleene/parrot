{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 263.0, 211.0, 1855.0, 1104.0 ],
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1132.0, 665.0, 150.0, 87.0 ],
                    "text": "Note that both changing the `fgcolor` or using show/hide will also clear the `spectrogram` contents, so instead we send to back to hide."
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 1057.0, 730.0, 67.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 670.0, 812.0, 173.0, 22.0 ],
                    "text": "loadmess fgcolor 0. 0.8 1. 0.45"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1085.0, 812.0, 179.0, 22.0 ],
                    "text": "loadmess fgcolor 1. 0.55 0. 0.45"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "float" ],
                    "patching_rect": [ 80.66666666666669, 391.0, 39.0, 22.0 ],
                    "text": "/ 100."
                }
            },
            {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 241.0, 467.0, 29.5, 22.0 ],
                                    "text": "t f f"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "float" ],
                                    "patching_rect": [ 239.0, 499.0, 33.0, 22.0 ],
                                    "text": "* 0.5"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 70.0, 469.0, 150.0, 87.0 ],
                                    "text": "Prevent flapping for values close to the threshold, by only resetting when the delta crosses below a certain value."
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "signal" ],
                                    "patching_rect": [ 224.0, 534.0, 49.0, 22.0 ],
                                    "text": "thresh~"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 180.0, 615.0, 32.0, 22.0 ],
                                    "text": "gate"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "int" ],
                                    "patching_rect": [ 180.0, 571.0, 49.0, 22.0 ],
                                    "text": "> 0.001"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 241.0, 571.0, 42.0, 22.0 ],
                                    "text": "edge~"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 344.0, 655.0, 32.0, 22.0 ],
                                    "text": "gate"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "bang", "bang" ],
                                    "patching_rect": [ 220.0, 703.0, 65.0, 22.0 ],
                                    "text": "onebang 1"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "bang" ],
                                    "patching_rect": [ 142.0, 659.0, 37.0, 22.0 ],
                                    "text": "delay"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "signal" ],
                                    "patching_rect": [ 226.5, 422.0, 42.0, 22.0 ],
                                    "text": "delta~"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 220.0, 757.0, 30.0, 30.0 ]
                                }
                            }
                        ],
                        "lines": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "bang", "bang" ],
                    "patching_rect": [ 977.0, 561.0, 32.0, 22.0 ],
                    "text": "t b b"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "bang", "bang" ],
                    "patching_rect": [ 937.0, 561.0, 32.0, 22.0 ],
                    "text": "t b b"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "bang", "bang" ],
                    "patching_rect": [ 897.0, 561.0, 32.0, 22.0 ],
                    "text": "t b b"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 897.0, 530.0, 139.0000000000001, 22.0 ],
                    "text": "select 0 1 2"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1328.0, 629.0, 146.0, 22.0 ],
                    "text": "script sendtoback Sample"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1181.0, 629.0, 145.0, 22.0 ],
                    "text": "script bringtofront Sample"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1019.0, 629.0, 135.0, 22.0 ],
                    "text": "script sendtoback Audio"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 881.0, 629.0, 135.0, 22.0 ],
                    "text": "script bringtofront Audio"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 670.0, 785.0, 49.0, 20.0 ],
                    "text": "Audio"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1085.0, 785.0, 49.0, 20.0 ],
                    "text": "Sample"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "patcher": {
                        ...
                        "classnamespace": "box",
                        "rect": [ 1121.0, 229.0, 1000.0, 780.0 ],
                        "subpatcher_template": "roben-kleene-max-for-live",
                        "visible": 1,
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "signal" ],
                                    "patching_rect": [ 8.0, 219.0, 116.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 8.0, 139.0, 119.0, 22.0 ],
                                    "text": "0, $1 $2 $3 $4 $5 $6"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 8.0, 107.0, 125.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "signal", "bang" ],
                                    "patching_rect": [ 8.0, 171.0, 45.0, 22.0 ],
                                    "text": "curve~"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 136.0, 107.0, 161.0, 87.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "float" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 897.0, 504.0, 47.0, 15.0 ],
                    "presentation": 1,
